...
TextColor3=ah=="Primary"and Color3.new(0,0,0)or ah=="White"and Color3.new(0,0,0)or nil,
AutomaticSize="XY",
TextSize=18,
})
})
...
Parent=ag,
ImageColor3=typeof(ah.Color)=="Color3"and ah.Color or Color3.new(0,0,0),
},{
ak,
ac("UIPadding",{
...
ad(al,.06,{ImageColor3=Color3.new(0,0,0)}):Play()
else
if ak then
ak:Destroy()
end
...
ao.ImageLabel.ImageColor3=Color3.new(0,0,0)
...
Default=as.Default or Color3.new(0,0,0),
